...
<section class="content">
	{!! Form::model($properties, [
                            'method' => 'PATCH',
                            'route' => ['properties.update', $properties->id], 
                            'files'=> true
                    ]) !!}
                        ...
                        <div class="card card-default escalation_block">
                            ...
                            <div class="card-body">
                                <div class="row escalation_block">
                                    <div class="col-md-6">
                                        ...
                                        <select name="is_escalation" id="is_escalation" class="form-control">
                                            ...
                                            <option @if (isset($properties->is_escalation)) {{ $properties->is_escalation == 1 ? 'selected' : '' }} @endif value="1">Yes</option>
                                            <option @if (isset($properties->is_escalation)) {{ $properties->is_escalation == 0 ? 'selected' : '' }} @endif value="0">No</option>
                                        </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row" id="show_escalation">
                                    <div class="col-md-3">
                                        <input type="checkbox"  name="is_garden_facing" value="1" @if (isset($properties->is_garden_facing)) {{ $properties->is_garden_facing == 1 ? 'checked' : '' }} @endif><label>&nbsp; Garden Facing</label> 
                                        <input type="text" name="garden_facing_amount"  class="form-control" value="{{$properties->garden_facing_amount}}">
                                    </div>
                                    <div class="col-md-3">
                                        <input type="checkbox" name="is_club_house_facing" value="1" @if (isset($properties->is_club_house_facing)) {{ $properties->is_club_house_facing == 1 ? 'checked' : '' }} @endif>
                                        <label>Club House Facing</label> 
                                        <input type="text" name="club_house_facing_amount" class="form-control" value="{{$properties->club_house_facing_amount}}">
                                    </div>
                                    <div class="col-md-3">
                                        <input type="checkbox" name="id_road_facing" value="1" @if (isset($properties->id_road_facing)) {{ $properties->id_road_facing == 1 ? 'checked' : '' }} @endif>
                                        <label>Road Facing</label>
                                        <input type="text" name="road_facing_amount" class="form-control" value="{{$properties->road_facing_amount}}" >
                                    </div>
                                    
                                    <div class="col-md-3">
                                        <input type="checkbox" name="is_croner_flat" value="1" @if (isset($properties->is_croner_flat)) {{ $properties->is_croner_flat == 1 ? 'checked' : '' }} @endif>
                                        <label>Corner Flats</label>
                                         <input type="text" name="corner_flat_amount" class="form-control" value="{{$properties->corner_flat_amount}}">
                                    </div>
                                    <div class="col-md-3">
                                        <input type="checkbox" name="is_others" value="1" @if (isset($properties->is_others)) {{ $properties->is_others == 1 ? 'checked' : '' }} @endif>
                                        <label>Others</label>                               
                                        <input type="text" name="other_amount" class="form-control" value="{{$properties->other_amount}}">
                                    </div>
                        ...
                        <div class="card card-default escalation_floor">
                            ...
                            <div class="card-body">
                                <div class="row escalation_block">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        <label>select total Floor ? <span style="color: red;">*</span></label>{{$properties->total_escalation_floors}}
                                        <select id="total_escalation_floors" name="total_escalation_floors"  class="form-control">
                                            <option>select </option>
                                            <?php $i=0;
                                            for($i=0;$i<=20;$i++){
                                            ?>
                                            <option @if ($properties->total_escalation_floors == $i)  selected  @endif value="{{$i}}">{{$i}}</option>
                                        <?php } ?>
                                ...
                                <div class="row" id="show_floor_escalation">
                                    ...
                                    @foreach($properties->escalations as $key => $escalations)
                                    <div class="col-md-12" style="margin-top:5px;"><input type="text" name="escalation_floor_price[]" value="{{ $escalations->price }}"  class="col-md-9 form-control"></div>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body" id="commerical-block-none">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                                <label>Fix Pay ?</label>
                                                <select name="brokrage_type" id="brokrage_type" class="form-control"   >
                                    ...
                                    <div class="col-md-4" id="fix_pay_type"   >
                                        <div class="form-group" >
                                            ...
                                            <select name="fix_pay_type" id="fix_pay_set_type" class="form-control" style="width: 100%;">
                                               ...
                                               <option @if (isset($properties->fix_pay_type)) {{ $properties->fix_pay_type == 1 ? 'selected' : '' }} @endif value="1"> Individual  </option>
                                               <option @if (isset($properties->fix_pay_type)) {{ $properties->fix_pay_type == 0 ? 'selected' : '' }} @endif value="0"> Package </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4" id="fix_pay_amount"  >
                                        <div class="form-group" >
                                            ...
                                            <input type="text" name="fix_pay_amount" class="form-control" value="{{$properties->fix_pay_amount}}" placeholder="Enter Salary/Fix Pay">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-3"  >
                                        <div class="form-group">
                                                ...
                                                <select name="is_commission" id="is_commission" class="form-control" style="width: 100%;">
                                                   ...
                                                   <option @if (isset($properties->is_commission)) {{ $properties->is_commission == 1 ? 'selected' : '' }} @endif value="1"> Yes  </option>
                                                   <option @if (isset($properties->is_commission)) {{ $properties->is_commission == 0 ? 'selected' : '' }} @endif value="0"> No </option>
                                                </select>
                                        </div>
                                    </div>
...
$("#total_escalation_floors").change(function(){
   ...
   var escalation = '{{$properties->is_escalation}}';
   if(escalation==1){
    ...
    var brokrage_type = '{{$properties->brokrage_type}}';
    ...
    var is_commission = '{{$properties->is_commission}}';
    ...
    $(document).on('click', '.deletePropertyImage', function(e) {
        ...
        if (typeof imageId != 'undefined' && imageId > 0) {
            if (confirm('Are you sure you want to delete this image')) {
                $.ajax({
                    url: '{{url("/deletePropertyImage")}}'+'/' + imageId,
                    method: 'GET',
                    data: $(this).serialize(),
                    beforeSend: function(data) {
                    },
