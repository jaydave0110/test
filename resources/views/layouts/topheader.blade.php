    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown user-menu">
        ...
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
          <span class="d-none d-md-inline">@if(!auth()->user()->roles->pluck('name')->isEmpty()){{ ucfirst(auth()->user()->roles->pluck('name')[0])}}@endif</span>
        </a>
        @endif
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          @else
           @if(!auth()->user()->roles->pluck('name')->isEmpty())
            <p>
              {{ ucfirst(auth()->user()->name)}}- {{ strtolower(auth()->user()->roles->pluck('name')[0])}}
