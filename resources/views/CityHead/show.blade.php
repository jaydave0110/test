                ...
                <div class="card-body pt-0">
                  <div class="row">
                    ...
                    <div class="col-4 text-center">
                      ...
                      <img src="{{asset('public/images/profileImage/'.$data['user']->profile_pic)}}" alt="no-image" class="img-circle img-fluid" style="margin-top: 40px;">
                      @else
                      <img src="{{asset('public/images/profileImage/noimage.png')}}" alt="user-avatar" class="img-circle img-fluid" style="margin-top: 40px;">
                      @endif
                    </div>
                  </div>
                </div>
