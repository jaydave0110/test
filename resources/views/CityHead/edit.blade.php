...
<section class="content">
	 @include('layouts.errorMessage')
                    ...
                    {!! Form::model($data['user'], [
                            ...
                            'route' => ['cityhead.update', $data['user']->id],
                            'files'=> true
                    ]) !!}
                    @csrf
                ...
                <div class="col-md-12">
                  	<div class="card card-default">
	                    <div class="card-header">
                       		 <h3 class="card-title">Edit City / Channel Head  Information</h3>
                             <a href="{{route('cityhead.index')}}" style="float: right;" class="btn btn-sm btn-primary">Back</a>
                    	 </div>
                     	<div class="card-body">
                     		<h2>City / Channel Head  Details</h2>
